...
internal class MealObject: RealmSwift.Object {
    ...
    convenience init(meal: Meal) {
        ...
        meal.componentsAndAmounts.forEach { componentAndAmount in
            self.componentsAndAmounts.append(MealObjectComponentAndAmount(componentAndAmount))
        }
    }
...
internal class MealObjectComponent: RealmSwift.Object {
    
}

internal class MealObjectComponentAndAmount: RealmSwift.Object {
    @objc dynamic private var component: MealObjectComponent? = nil
